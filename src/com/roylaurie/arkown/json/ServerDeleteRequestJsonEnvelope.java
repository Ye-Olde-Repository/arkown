 ...
 *
 */
public final class ServerDeleteRequestJsonEnvelope extends JsonEnvelope {
    public static final String PROTOTYPE_SERVER = "server";
    
    public ServerDeleteRequestJsonEnvelope() {
    ...
    public ServerDeleteRequestJsonEnvelope(String json) throws JsonException {
        super(ArkownJsonFactory.getInstance());
